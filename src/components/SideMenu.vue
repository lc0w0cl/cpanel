...
<template>
  <div class="left-side">
    ...
    <div class="side-wrapper">
      <div class="side-title">应用</div>
      <div class="side-menu">
        <a href="#" @click.prevent="handleCategoryClick('all')" :class="{ 'active': activeCategory === 'all' }">
        ...
        <a href="#" @click.prevent="handleCategoryClick('updates')" :class="{ 'active': activeCategory === 'updates' }">
    ...
    <!-- 类别部分 -->
    <div class="side-wrapper">
      <div class="side-title">类别</div>
      <div class="side-menu">
        <a href="#" @click.prevent="handleCategoryClick('photography')" :class="{ 'active': activeCategory === 'photography' }">
        ...
        <a href="#" @click.prevent="handleCategoryClick('graphic')" :class="{ 'active': activeCategory === 'graphic' }">
        ...
        <a href="#" @click.prevent="handleCategoryClick('video')" :class="{ 'active': activeCategory === 'video' }">
        ...
        <a href="#" @click.prevent="handleCategoryClick('illustration')" :class="{ 'active': activeCategory === 'illustration' }">
          <svg viewBox="0 0 512 512" fill="currentColor">
        ...
        <a href="#" @click.prevent="handleCategoryClick('ui-ux')" :class="{ 'active': activeCategory === 'ui-ux' }">
          <svg viewBox="0 0 512 512" fill="currentColor">
        ...
        <a href="#" @click.prevent="handleCategoryClick('3d-ar')" :class="{ 'active': activeCategory === '3d-ar' }">
          <svg viewBox="0 0 512 512" fill="currentColor">
    ...
    <!-- 字体部分 -->
    <div class="side-wrapper">
      <div class="side-title">字体</div>
      <div class="side-menu">
        <a href="#" @click.prevent="handleCategoryClick('fonts')" :class="{ 'active': activeCategory === 'fonts' }">
    ...
    <!-- 资源链接部分 -->
    <div class="side-wrapper">
      <div class="side-title">资源链接</div>
      <div class="side-menu">
        <a href="#" @click.prevent="handleCategoryClick('stock')" :class="{ 'active': activeCategory === 'stock' }">
          <svg viewBox="0 0 512 512" fill="currentColor">
        ...
        <a href="#" @click.prevent="handleCategoryClick('tutorials')" :class="{ 'active': activeCategory === 'tutorials' }">
        ...
        <a href="#" @click.prevent="handleCategoryClick('portfolio')" :class="{ 'active': activeCategory === 'portfolio' }">
          <svg viewBox="0 0 512 512" fill="currentColor">
        ...
        <a href="#" @click.prevent="handleCategoryClick('behance')" :class="{ 'active': activeCategory === 'behance' }">
          <svg viewBox="0 0 512 512" fill="currentColor">
        ...
        <a href="#" @click.prevent="handleCategoryClick('forum')" :class="{ 'active': activeCategory === 'forum' }">
          <svg viewBox="0 0 512 512" fill="currentColor">
